...
MODIS albedo
*/
var poi = ee.FeatureCollection("projects/ee-ivanburgov666/assets/randomGR5km");
...
var dataset = ee.ImageCollection('MODIS/061/MOD11A1') // 
                .filter(imgfilter)
                .select(["LST_Day_1km", "LST_Night_1km"]); // Snow_Albedo_Daily_Tile_Class
...
var poiLST = poi.map(function(feature) {
