...
target_dir =  "/mnt/i/SCIENCE-IGN-ALL/AVOCA_Group/1_Personal_folders/1_Simon/1_Abisko/6_Tower_Data/Tower Thermal images/2_Extracted_Data"  # Change this to your target folder path
# =================================
#%%
    ...
    for tar_path, extract_dir in tqdm(tar_files, desc="Extracting tar files"):
        ...
        try:
            with tarfile.open(tar_path) as tar:
                tar.extractall(path=extract_dir, filter=tarfile.FILTER_FULLY_TRUSTED)
